...
namespace HR.LeaveManagement.MVC.Services.Base
{
    ...
    public partial class Client : IClient
    {
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/LeaveRequests/changeapproval?");
            if (id != null)
            {
    ...
    public partial class CreateLeaveAllocationDto
    {
        ...
        [Newtonsoft.Json.JsonProperty("leaveTypeDtoID", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
